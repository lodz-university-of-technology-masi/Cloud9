...
public class GetRecruiterQuestionsHandler implements RequestHandler<Map<String, Object>, ApiGatewayResponse> {
	...
	public ApiGatewayResponse handleRequest(Map<String, Object> input, Context context) {
		try {
	        ...
	        String recruiterId = pathParameters.get("recruiterid");

	       List<Question> questions = new QuestionDBTable().getRecruiterQuestions(recruiterId);
