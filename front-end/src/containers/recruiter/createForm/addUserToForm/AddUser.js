...
export default class AddUser extends Component {
    ...
    nextStep = async event => {
        ...
        this.setState({
            isLoading: false,
            redirectForm: this.state.form.id
        })
    }
    ...
    render() {
        ...
        if(this.state.redirectForm.length)
            return (<Redirect to={`/recruiter_panel/forms/${this.state.redirectForm}/questions`} />)
        return(
                                ...
                                <div className="card">
                                    ...
                                    <div className="card-body">
                                        ...
                                        <Fragment>
                                            <div>
                                                <div className="text-left mt-4 mb-4">
                                                    <h4>Jeżeli chcesz możesz pominąć ten krok. <button type="button" className="btn btn-outline-primary btn-sm" onClick={this.nextStep}>Pomiń</button></h4>
                                                </div>
                                            </div>
                                        </Fragment>}
